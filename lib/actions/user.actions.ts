...
export const signUp = async ({password, ...userData}: SignUpParams) =>{
    ...
    try {
      ...
      // create appwrite user
        ...
        // console.log('Direct newUser from Appwrite:', newUser);
        // return newUser; // Return directly to test  
    } catch (error) {
        console.log(error)
    }
}
...
export async function getLoggedInUser() {
  ...
  // Get a bank document getBankByAccountId
  export const getBank = async ({documentId}: getBankProps) => {
   ...
   // Get a bank document by account Id
